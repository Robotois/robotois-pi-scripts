...
case "$1" in
start) exec forever --sourceDir=/home/pi/Documents/Robotois/webserverpi -p /home/pi/Documents/Robotois/webserverpi index.js
;; stop)
exec forever stop --sourceDir=/home/pi/Documents/Robotois/webserverpi index.js
;;
*)
